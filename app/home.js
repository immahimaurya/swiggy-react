...
<html lang="en">
   ...
   <body class="fixed-bottom-bar">
               ...
               <div class="row align-items-center">
                  ...
                  <div class="col-3 d-flex align-items-center m-none">
                     <div class="dropdown me-3">
                        ...
                        <div class="dropdown-menu p-0 drop-loc border-0">
                              ...
                              <div class="filter">
                                 ...
                                 <div class="border-bottom p-3">
                                    <div class="form-check form-check-reverse m-0">
                                       <input type="radio" id="customRadio1" name="location" class="form-check-input">
                                       <label class="form-check-label text-start w-100" for="customRadio1">Afghanistan</label>
                                    </div>
                                 </div>
                                 <div class="border-bottom p-3">
                                    <div class="form-check form-check-reverse m-0">
                                       <input type="radio" id="customRadio2" name="location" class="form-check-input" checked>
                                       <label class="form-check-label text-start w-100" for="customRadio2">India</label>
                                    </div>
                                 </div>
                                 <div class="border-bottom p-3">
                                    <div class="form-check form-check-reverse m-0">
                                       <input type="radio" id="customRadio3" name="location" class="form-check-input">
                                       <label class="form-check-label text-start w-100" for="customRadio3">USA</label>
                                    </div>
                                 </div>
                                 <div class="border-bottom p-3">
                                    <div class="form-check form-check-reverse m-0">
                                       <input type="radio" id="customRadio4" name="location" class="form-check-input">
                                       <label class="form-check-label text-start w-100" for="customRadio4">Australia</label>
                                    </div>
                                 </div>
                                 <div class="border-bottom p-3">
                                    <div class="form-check form-check-reverse m-0">
                                       <input type="radio" id="customRadio5" name="location" class="form-check-input">
                                       <label class="form-check-label text-start w-100" for="customRadio5">Japan</label>
                                    </div>
                                 </div>
                                 <div class="p-3">
                                    <div class="form-check form-check-reverse m-0">
                                       <input type="radio" id="customRadio6" name="location" class="form-check-input">
                                       <label class="form-check-label text-start w-100" for="customRadio6">China</label>
                                    </div>
                                 </div>
                              </div>
                           </div>
               ...
               <div class="cat-slider">
                  <div class="cat-item px-1 py-3">
                     <div class="bg-white rounded position-relative p-2 text-center shadow-sm">
                        <img src="img/1.png" class="img-fluid rounded-3 p-3" alt="...">
                        ...
                        <a href="trending.html" class="stretched-link"></a>
                     </div>
                  </div>
                  <div class="cat-item px-1 py-3">
                     <div class="bg-white rounded position-relative p-2 text-center shadow-sm">
                        <img src="img/2.png" class="img-fluid rounded-3 p-3" alt="...">
                        <div class="listing-card-body pt-0">
                  ...
                  <div class="cat-item px-1 py-3">
                     <div class="bg-white rounded position-relative p-2 text-center shadow-sm">
                        <img src="img/3.png" class="img-fluid rounded-3 p-3" alt="...">
                        <div class="listing-card-body pt-0">
                  ...
                  <div class="cat-item px-1 py-3">
                     <div class="bg-white rounded position-relative p-2 text-center shadow-sm">
                        <img src="img/4.png" class="img-fluid rounded-3 p-3" alt="...">
                        <div class="listing-card-body pt-0">
                  ...
                  <div class="cat-item px-1 py-3">
                     <div class="bg-white rounded position-relative p-2 text-center shadow-sm">
                        <img src="img/5.png" class="img-fluid rounded-3 p-3" alt="...">
                        <div class="listing-card-body pt-0">
                  ...
                  <div class="cat-item px-1 py-3">
                     <div class="bg-white rounded position-relative p-2 text-center shadow-sm">
                        <img src="img/6.png" class="img-fluid rounded-3 p-3" alt="...">
                        <div class="listing-card-body pt-0">
                  ...
                  <div class="cat-item px-1 py-3">
                     <div class="bg-white rounded position-relative p-2 text-center shadow-sm">
                        <img src="img/7.png" class="img-fluid rounded-3 p-3" alt="...">
                        <div class="listing-card-body pt-0">
                  ...
                  <div class="cat-item px-1 py-3">
                     <div class="bg-white rounded position-relative p-2 text-center shadow-sm">
                        <img src="img/8.png" class="img-fluid rounded-3 p-3" alt="...">
                        <div class="listing-card-body pt-0">
                  ...
                  <div class="cat-item px-1 py-3">
                     <div class="bg-white rounded position-relative p-2 text-center shadow-sm">
                        <img src="img/9.png" class="img-fluid rounded-3 p-3" alt="...">
                        <div class="listing-card-body pt-0">
                  ...
                  <div class="cat-item px-1 py-3">
                     <div class="bg-white rounded position-relative p-2 text-center shadow-sm">
                        <img src="img/10.png" class="img-fluid rounded-3 p-3" alt="...">
                        <div class="listing-card-body pt-0">
                  ...
                  <div class="cat-item px-1 py-3">
                     <div class="bg-white rounded position-relative p-2 text-center shadow-sm">
                        <img src="img/11.png" class="img-fluid rounded-3 p-3" alt="...">
                        <div class="listing-card-body pt-0">
                  ...
                  <div class="cat-item px-1 py-3">
                     <div class="bg-white rounded position-relative p-2 text-center shadow-sm">
                        <img src="img/12.png" class="img-fluid rounded-3 p-3" alt="...">
                        <div class="listing-card-body pt-0">
      ...
      <script type="4ac8803fd029207e219bd918-text/javascript" src="vendor/jquery/jquery.min.js"></script>
      <script type="4ac8803fd029207e219bd918-text/javascript" src="vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
      <script type="4ac8803fd029207e219bd918-text/javascript" src="vendor/slick/slick/slick.min.js"></script>
      <script type="4ac8803fd029207e219bd918-text/javascript" src="vendor/sidebar/hc-offcanvas-nav.js"></script>
      <script type="4ac8803fd029207e219bd918-text/javascript" src="js/osahan.js"></script>
      <script src="js/rocket-loader.min.js" data-cf-settings="4ac8803fd029207e219bd918-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/v84a3a4012de94ce1a686ba8c167c359c1696973893317" integrity="sha512-euoFGowhlaLqXsPWQ48qSkBSCFs3DPRyiwVu3FjR96cMPx+Fr+gpWRhIafcHwqwCqWS42RZhIudOvEI+Ckf6MA==" data-cf-beacon='{"rayId":"836013084b909fb9","version":"2023.10.0","r":1,"token":"dd471ab1978346bbb991feaa79e6ce5c","b":1}' crossorigin="anonymous"></script>
   </body>
   <!-- Mirrored from askbootstrap.com/preview/swiggiweb-v1-1/organic/home.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Dec 2023 16:31:33 GMT -->
</html>